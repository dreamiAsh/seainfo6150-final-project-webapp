...
const TermService = (props) => {
  return (
    <div className={styles.box}>
        <Other title="Terms of Service Agreement" content='PLEASE READ THIS TERMS AND CONDITIONS AGREEMENT ("AGREEMENT") CAREFULLY. THIS AGREEMENT IS A LEGAL CONTRACT BETWEEN YOU ("USER") AND MEREDITH CORPORATION ("MEREDITH," "COMPANY," "WE," OR "US").
...
2.1 Order Acceptance. Each part of any order that you submit to Meredith constitutes an offer to purchase. If you do not receive a message from Meredith confirming receipt of your order, please contact our Customer Service department before re-entering your order. '/>
    </div>
  );
};
